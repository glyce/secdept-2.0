        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?php echo site_url('assets/img/app/logoEBVSAI.png'); ?>" class="user-image" alt="User Image">
                        <span class="hidden-xs"><?php echo $user_details->first_name . ' ' . $user_details->last_name; ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="user-header">
                            <img src="<?php echo site_url('assets/img/app/logoEBVSAI.png'); ?>" class="img-circle" alt="User Image">
                            <p>
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <a href="<?php echo site_url('auth/logout'); ?>" class="btn btn-warning btn-flat">Sign out</a>
                            </div>
                        </li>
                    </ul>
                </li>
