...
class navigation {
     ...
     * Store class navigation_model
     */
    protected $system_role_permission_model;
	...
	function __construct()
	{
		...
		$this->navigation_model = $this->ci->navigation_model;
		$this->system_role_permission_model = $this->ci->system_role_permission_model;
	}

	public function get_role_navigation_menu($role_id)
	{
		$modules = $this->navigation_model->get_role_permission_modules([
		...
		foreach ($modules as $module)
		{
			...
			$modules_functions = $this->navigation_model->get_role_permission_functions([
	...
	public function get_system_role_permission()
	{
		...
		foreach ($modules as $module)
		{
			...
			$modules_functions = $this->navigation_model->get_system_functions([
				'role_permission.active_status' => 1,
				's_function.system_module_id' 	=> $module->s_module_id
			]);
			...
			{
				dump($component);
				$role_permissions = $this->system_role_permission_model->get_many_role_permission_by([
...
/* Location: ./application/library/navigation.php */
